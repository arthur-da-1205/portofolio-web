...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full shadow-md">
      <div className="items-center justify-between py-4 bg-transparent md:flex md:px-10 px-7">
        ...
        <ul
          className={`absolute pb-12 md:flex md:items-center md:pb-0 md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-300 ease-in-out ${
            open ? "top-20 opacity-90" : "top-[-500px]"
          } md:opacity-95 opacity-0 `}
        >
          {Links.map((link) => (
